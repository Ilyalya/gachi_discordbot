...
#         source = discord.PCMVolumeTransformer(discord.FFmpegPCMAudio('/Users/lebedevila/PycharmProjects/gachi_discordbot/sounds/Swallow my cum.mp3'))
#         ctx.voice_client.play(source, after=lambda e: print('Player error: %s' % e) if e else None)
#         await ctx.send()

bot.add_cog(Music(bot))
bot.run('ODg4NDc4MjQ0Njc5MDYxNTQ0.YUTR2A.7ceFT44hDBh1r42Yb3DZcYhZuiY')
